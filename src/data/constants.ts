...
using use = useUsing("use")`,
  ...
  [SkillNames.PRETTIER]: {
    ...
    name: "prettier",
    label: "C++",
    shortDescription: "Highly optimized low-level systems programming and problem solving! 💻🚀",
    color: "#00599c",
  ...
  [SkillNames.WORDPRESS]: {
    ...
    name: "wordpress",
    label: "Flutter",
    shortDescription: "Crafting premium, high-performance cross-platform mobile apps! 📱✨",
    color: "#02569B",
  ...
  [SkillNames.NGINX]: {
    ...
    name: "nginx",
    label: "Redis",
    shortDescription: "Ultra-fast in-memory caching and messaging for scalable systems! ⚡💾",
    color: "#d82c20",
  ...
  [SkillNames.VIM]: {
    ...
    name: "vim",
    label: "Python",
    shortDescription: "Supercharging machine learning, data engineering, and automation! 🐍🔥",
    color: "#3572A5",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    endDate: "Present",
    title: "Core Member",
    company: "FOSS Club (GEHU Dehradun)",
    description: [
      "Free and Open Source Software (FOSS) club core member, promoting open source culture and tools among student developers.",
      "Collaborating on community repositories, contributing to web projects, and assisting in organizing technical events and workshops.",
    ],
    skills: [SkillNames.GIT, SkillNames.GITHUB, SkillNames.LINUX],
  },
  {
    id: 2,
    startDate: "Aug 2025",
    ...
    company: "Team Aryavart (GEHU Dehradun)",
    description: [
      "Part of the Aryavart student club technical team, building web interfaces and helping manage event registration portals.",
      "Worked in a collaborative Git environment with junior and senior developers on local community solutions.",
    ],
  ...
  },
  {
    ...
    skills: [SkillNames.REACT, SkillNames.HTML, SkillNames.CSS],
  },
];
